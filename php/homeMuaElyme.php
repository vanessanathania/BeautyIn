    ...
    <div class="container">
        ...
        <div class="profile-header">
            <div class="profile-img">
                <img src="../asset/S__14074963.jpg" width="200" alt="">
            </div>
        ...
        <div class="main-bd">
            <div class="left-side">
                    <div class="profile-side">
                            <p class="user-mail">
                                <i class="fa fa-envelope">ElymeFreesia@gmail.com</i>
                            </p>
                    <div class="user-bio">
                    <p class="bio">Certified AirBrush MUA since 2010. Available home service and on the spot. Feel free to chat or call me before booking appoinment or for discount price too :) </p>
                    </div>
                ...
                <div class="right-side">
                        ...
                        <div class="profile-body">
                            ...
                            <div class="profile-pricelist tab">
                                <h1>Price List</h1>
                                <p>1. Makeup Only - IDR 400.000</p>
                                <p>2. Hairdo Only - IDR 100.000</p> 
                                <p>3. Makeup+Hairdo - IDR 490.000</p>   
    ...
    <footer>
     ...
     <div class="bg-modal1">
            <div class="modal-content1">
                <div class="close"><a href="homeMuaElyme.php">+</a></div>
                <p>+6281322055877</p>
            </div>
