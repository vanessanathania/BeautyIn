    ...
    <div class="container">
        ...
        <div class="profile-header">
            <div class="profile-img">
                <img src="../asset/bb.jpg" width="200" alt="">
            </div>
        ...
        <div class="main-bd">
            <div class="left-side">
                    <div class="profile-side">
                            <p class="user-mail">
                                <i class="fa fa-envelope">NiveoleRue@gmail.com</i>
                            </p>
                    <div class="user-bio">
                    <p class="bio">Certified AirBrush MUA since 2013. Available home service and on the spot. Feel free to chat or call me before booking appoinment or for discount price too :) </p>
                    </div>
                ...
                <div class="right-side">
                        ...
                        <div class="profile-body">
                            <div class="profile-posts tab">
                                <img class="poto" src="../asset/A2.jpg" alt="">
                                <img class="poto" src="../asset/M3.jpg" alt="">
                                <img class="poto" src="../asset/M2.jpg" alt=""> 
                            </div>
    ...
    <footer>
     ...
     <div class="bg-modal1">
            <div class="modal-content1">
                <div class="close"><a href="homeMuaNiveole.php">+</a></div>
                <p>+6281322055877</p>
            </div>
