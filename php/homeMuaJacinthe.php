    ...
    <div class="container">
        ...
        <div class="profile-header">
            <div class="profile-img">
                <img src="../asset/S__14074954.jpg" width="200" alt="">
            </div>
        ...
        <div class="main-bd">
            <div class="left-side">
                    <div class="profile-side">
                            <p class="user-mail">
                                <i class="fa fa-envelope">JacintheNiveole@gmail.com</i>
                            </p>
                    <div class="user-bio">
                ...
                <div class="right-side">
                        ...
                        <div class="profile-body">
                            ...
                            <div class="profile-pricelist tab">
                                ...
                                <p>3. Makeup+Hairdo - IDR 550.000</p>   
    ...
    <footer>
     ...
     <div class="bg-modal1">
            <div class="modal-content1">
                <div class="close"><a href="homeMuaJacinthe.php">+</a></div>
                <p>+6281322055877</p>
            </div>
