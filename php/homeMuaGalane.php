    ...
    <div class="container">
        ...
        <div class="profile-header">
            <div class="profile-img">
                <img src="../asset/S__14074962.jpg" width="200" alt="">
            </div>
        ...
        <div class="main-bd">
            <div class="left-side">
                    <div class="profile-side">
                            <p class="user-mail">
                                <i class="fa fa-envelope">GalaneBouteloua@gmail.com</i>
                            </p>
                    <div class="user-bio">
                ...
                <div class="right-side">
                        ...
                        <div class="profile-body">
                            ...
                            <div class="profile-pricelist tab">
                                <h1>Price List</h1>
                                <p>1. Makeup Only - IDR 700.000</p>
                                <p>2. Hairdo Only - IDR 250.000</p> 
                                <p>3. Makeup+Hairdo - IDR 850.000</p>   
    ...
    <footer>
     ...
     <div class="bg-modal1">
            <div class="modal-content1">
                <div class="close"><a href="homeMuaGalane.php">+</a></div>
                <p>+6281322055877</p>
            </div>
