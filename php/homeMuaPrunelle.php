    ...
    <div class="container">
        ...
        <div class="profile-header">
            <div class="profile-img">
                <img src="../asset/b.jpg" width="200" alt="">
            </div>
        ...
        <div class="main-bd">
            <div class="left-side">
                    <div class="profile-side">
                            <p class="user-mail">
                                <i class="fa fa-envelope">PrunelleSouchet@gmail.com</i>
                            </p>
                    <div class="user-bio">
                    <p class="bio">Certified AirBrush MUA since 2016. Available home service and on the spot. Feel free to chat or call me before booking appoinment or for discount price too :) </p>
                    </div>
                ...
                <div class="right-side">
                        ...
                        <div class="profile-body">
                            <div class="profile-posts tab">
                                <img class="poto" src="../asset/E2.jpg" alt="">
                                <img class="poto" src="../asset/T3.jpg" alt="">
                                <img class="poto" src="../asset/J3.jpg" alt=""> 
                            </div>
                            ...
                            <div class="profile-pricelist tab">
                                <h1>Price List</h1>
                                <p>1. Makeup Only - IDR 500.000</p>
                                <p>2. Hairdo Only - IDR 250.000</p> 
                                <p>3. Makeup+Hairdo - IDR 749.000</p>   
    ...
    <footer>
     ...
     <div class="bg-modal1">
            <div class="modal-content1">
                <div class="close"><a href="homeMuaPrunelle.php">+</a></div>
                <p>+6281322055877</p>
            </div>
